...
interface MoviesApi {
    @GET("movie/popular")
    suspend fun getMovies(@Query("page") page: Int, @Query("api_key") key: String = MOVIESTBAPI): Response<com.example.paging.movies.data.local.entities.Response<MovieEntity>>
}