package com.jaozinfs.moovs.tvs.data.mappers

import com.jaozinfs.moovs.database.local.entities.series.TvEntity
import com.jaozinfs.moovs.tvs.data.network.response.EpisodeResponse
import com.jaozinfs.moovs.tvs.data.network.response.SeasonDetailsResponse
import com.jaozinfs.moovs.tvs.data.network.response.TvDetailsResponse
import com.jaozinfs.moovs.tvs.data.network.response.TvResponse
import com.jaozinfs.moovs.tvs.domain.model.*
