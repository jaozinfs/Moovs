package com.jaozinfs.moovs.ui.view
...
class RatingView(
    ...
    private val plain by lazy {
        ResourcesCompat.getFont(context, R.font.alfa_slab_one)!!
    }
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.apply {
            ...
            val bounds = Rect()
            val rating = "$rating ${if (isPercent) "%" else ""}"
            paintRating.getTextBounds(rating, 0, rating.length, bounds)
